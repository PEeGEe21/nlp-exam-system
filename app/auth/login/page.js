...
const LoginPage = () => {
  return (
        <div class="relative flex flex-col text-gray-700 w-full bg-white">
          <div
            class="relative grid mb-4 mt-6 overflow-hidden text-white shadow-lg h-28 place-items-center rounded-xl bg-gradient-to-tr from-gray-900 to-gray-800 bg-clip-border shadow-gray-900/20">
            <h3 class="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal">
              Sign In
            </h3>
          </div>
