...
import AddOptionTypeModal from '../Modals/optionType/AddOptionTypeModal';
import EditOptionTypeModal from '../Modals/optionType/EditOptionTypeModal';
...
const QuestionTypeTable = ({user, users, data, fetchData, isLoading}) => {
    ...
    const {
        isOpen: optionTypeEditIsOpen,
        onOpen: onOptionTypeEditOpen,
        onClose: onOptionTypeEditClose,
    } = useDisclosure();
    const pageSize = 10; 
        ...
        },
        {
            ...
            <Space size="middle">
                <button 
                    ...
                    onClick={() => {
                        setCurrentQuestionType(record);
                        onOptionTypeEditOpen();
                      }}>
                    <Edit size={14}/> Edit
                </button>
                {/* <button 
    ...
    const toggleCurrentTypeStatus = async(text, record, index, status) => {
        ...
        // if(currentQuestionType){
            ...
            try {
                ...
                const resp = await axios.post(hostUrl + `option-types/update-status/`+record?.id);
    ...
    const deleteType = (data) => {
        Swal.fire({
            ...
            preConfirm: async () => {
                try {
                    const response = await axios.delete(hostUrl + 'option-types/delete/'+ parseInt(data.id));
