          ...
          <nav className="flex  flex-wrap items-center justify-between py-4">
            ...
            <div className="hidden lg:order-2 lg:block w-full lg:w-auto lg:text-center">
              <div className="navbar-menu flex items-center justify-end gap-5  ">
                <Link
                  className="text-[#11161F] hover:text-[#000] px-6 py-2 menu relative text-center font-semibold group"
                  href={
                    '/'
                  }
                  target="_blank"
                ...
                <Link
                  href="/auth/login"
                  className="text-[#11161F] hover:text-[#000]  px-6 py-2 rounded-lg text-center font-semibold group"
                >
                  <div className='relative'>
                    Login
                  </div>
