...
const EditOptionTypeForm = ({
  ...
  const [inputs, setInputs] = useState({
    title: currentQuestionType?.title ?? '',
  ...
  const handleSubmit = async (e) => {
    ...
    if (handleValidation()) {
      try {
        ...
        const res = await axios.post(hostUrl + `option-types/update-type/${currentQuestionType?.id}`, payload);
...
export default EditOptionTypeForm;
